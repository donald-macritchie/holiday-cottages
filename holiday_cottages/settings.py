"""
Django settings for holiday_cottages project.
...
ROOT_URLCONF = 'holiday_cottages.urls'
...
WSGI_APPLICATION = 'holiday_cottages.wsgi.application'
...
MEDIA_URL = '/media/'
DEFAULT_FILE_STORAGE = 'cloudinary_storage.storage.MediaCloudinaryStoarge'
