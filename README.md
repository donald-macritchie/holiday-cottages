...
![This is an image of the Cottage Button in the navbar](./static/screenshots/navbar-cottage-button.png)
...
![This is an image of the contact button in the navbar](./static/screenshots/navbar-contact-button.png)
...
![This is an image of the of the Things to do button in the navbar](./static/screenshots/navbar-thingstodo-button.png)

##### Sign Up

- The "Sign up" link directs users to the sign up page where they can create a personal account for Hill Cottages.

![This is a screenshot of teh sign up button in the navbar](./static/screenshots/navbar-signup-button.png)
...
![This is an image of the profile button in the navbar](./static/screenshots/navbar-profile-button.png)
...
![This is an  image of the homepage welcome message](./static/screenshots/homepage-welcome-message.png)
...
![This is an image of the Homepage Cottages links](./static/screenshots/homepage-cottages-links.png)
...
![This is an image of teh home page site links](./static/screenshots/homepage-site-links.png)
...
![This is an image of the Marketview page hero image](./static/screenshots/marketview-hero-image.png)

#### Image Gallery

- The image gallery contains all the cottage images associated with that specific cottage. 
  
![This is an image of the Homestead initial image](./static/screenshots/homestead-initial-image.png)

- When clicked, the user will be able to navigate through the images by way of indicator arrows at the side of the image. This will clearly show all elements of the cottage from living space to kitchen to bedrooms, etc.

![This is an image of the image gallery modal](./static/screenshots/homestead-image-modal.png)
...
![This is an image of the cottage description](./static/screenshots/homestead-descriotion.png)
...
![This is an image of the booking page](./static/screenshots/booking-page.png)
...
![This is an image of the amenities list in the cottage page](./static/screenshots/amenities-list.png)
...
![This is an image of the loaction description](./static/screenshots/location-description.png)

##### Directions

- Directions have been included from the two nearest towns to the specfic cottage.

![This is an image of the directions description](./static/screenshots/directions-description.png)

##### Map

- A Google Map displays the location of the cottage with the use of a marker.

![This si an image of the map section](./static/screenshots/map-section.png)
...
![This is an image of the Things To Know section](./static/screenshots/thingstoknow-section.png)

### Contact

A contact page has been created for users of the site to get in contact with the host before, during or after their stay

Similar to the other site pages, the Contact page has a hero Image and a message displaying to inform users that if they have any queries, they can get in contact.

![Thi is an image of the Contact page hero image](./static/screenshots/contact-hero-image.png)
...
![This is an image of the host details on the contact page](./static/screenshots/contact-details.png)
...
![This is an image of teh Things to do walks and hikes section](./static/screenshots/things-to-do-walks.png)
...
![This is an image of the pubs and restaurants section](./static/screenshots/things-to-do-pubs.png)
...
![This is an image of the local attractions section](./static/screenshots/things-to-do-attractions.png)
...
![This is an image of the sign up page](./static/screenshots/signup-page.png)
...
![This is an image of the user details section i the profile page](./static/screenshots/profile-user-details.png)
...
![This is an image of the user bookings section on the profile page](./static/screenshots/profile-user-bookings.png)
